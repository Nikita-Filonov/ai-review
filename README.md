...
- **Multiple LLM providers** — choose between **OpenAI**, **Claude**, **Gemini**, **Ollama**, **OpenRouter**,
  or **Azure OpenAI** and switch anytime.
...
- **LLM provider** — OpenAI, Gemini, Claude, Ollama, OpenRouter, or Azure OpenAI
